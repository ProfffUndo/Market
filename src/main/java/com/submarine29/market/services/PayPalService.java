...
public class PayPalService {
    ...
    public Payment createPayment(
        ...
        payer.setPaymentMethod("paypal"); //credit_card - альтернатива, в нашем случае возможен только paypal

        Payment payment = new Payment();
        payment.setIntent("sale"); //sale - мгновенный перевод денег от покупателя к продавцу, authorize - через 29 дней
